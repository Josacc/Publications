...
::: {.justify}
Se abordará la prática mediante la resolución de dos ejercicios con el 
...
::: {.justify}
Se deben cargar las bilbiotecas necesarias para ambos ejercicicos. En caso de no tener 
descargado los respectivos paquetes consultar 
...
Se toma el ejercicio de la sección 8.5.2 de *Nonparametric Statistics: A Step‑by‑Step Approach* [@corder2014], 
notemos ...
```{r }
#| eval: false
#| echo: true
